...
export SAXON_HOME=~/saxon/saxon9he.jar

# Set this to the path where you downloaded the Apache Commons JAR
export APACHE_COMMONS=~/javarepo/commons-lang3-3.1/commons-lang3-3.1.jar

# Set this to the path where you compiled the Java source
export SNAC_JAVA=~/SNAC-Saxon-Extensions/java/bin
